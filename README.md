...
```bash
adb shell monkey -p com.omnistream.omnistream_iptv -c android.intent.category.LAUNCHER 1
adb shell monkey -p com.omnistream.omnistream_iptv -c android.intent.category.LEANBACK_LAUNCHER 1
```
...
- `android/app/build.gradle.kts` → `defaultConfig { applicationId = "com.omnistream.omnistream_iptv" }`
