...
import 'package:omnistream_iptv/features/navigation/presentation/pages/splash_page.dart';
import 'package:omnistream_iptv/features/navigation/presentation/pages/epg_settings_page.dart';
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return VideoPlayerPage(
            ...
            quickOverlay: extras['quickOverlay'] as bool? ?? false,
          );
        },
      ),

      /// FULLSCREEN - EPG global (módulo 3)
      GoRoute(
        path: '/epg',
        name: 'epg',
        parentNavigatorKey: rootNavigatorKey,
        builder: (context, state) {
          final extras = state.extra as Map<String, dynamic>?;
          final channels = (extras?['channels'] as List?)?.cast<Channel>() ?? const <Channel>[];
          return EpgTimelinePage(
            channels: channels,
            currentChannel: extras?['currentChannel'] as Channel?,
            playlistUrl: extras?['playlistUrl'] as String?,
            returnSelection: extras?['returnSelection'] as bool? ?? false,
          );
        },
      ),
    ],
